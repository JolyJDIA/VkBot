...
public class YandexTraslate extends JavaModule {
    ...
    @NotNull
    static String translate(@NotNull @NonNls Language lang, String input) throws IOException {
        @NonNls StringBuilder builder = new StringBuilder("язык ").append(lang.name()).append('?').append("Перевод:\n");
        URL url = new URL(KEY);
